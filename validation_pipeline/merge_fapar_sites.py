...
def main():
    ...
    command = "gsutil ls gs://felixspecker/open-earth/validation/fapar/COPERNICUS_GBOV_RM6,7_20240620120826_*_reflectances_with_angles.csv"
    files_names = (
    ...
    for file in files_names:
        command = f"gsutil cp {file} data/validation_pipeline/output/fapar/"
